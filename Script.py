class script(object):
    START_TXT = """<b>⚡ කොහොමද ඉතින් ඔයාට {} 😎🤘
මම <a href=https://t.me/{}>{}</a> 🔥,  Movies 🎬 | Series 📺 | Mod Apps 📲 සහ පොත්පත් 📚 ඇතුළු බොහෝමයක් Files හොයාගන්න 🔎 උදව් කරන්න මට පුලුවන් ✅   | 👉 Search කරන්න 🔎 | Option එක හරහා ඔයාට අවශ්‍ය Files 📁 ලබාගන්න පුලුවන් වගේම, අපේ Support Group 🔆 එකට Join වෙලත් ඔයාට අවශ්‍ය Files 📁 පහසුවෙන්ම හොයාගන්න පුලුවන් ❤️</b>"""
...
✯ Database 📁: <a href='https://www.mongodb.com/'>Mongo DB ☣️</a>
...
Nᴀᴍᴇ - {}"""
    ...
    ALRT_TXT = """මචං {},
මේක ඔයා දාපු file request එකක් නෙවෙයි 🥴,
ඒ නිසා ඔය අලුතින් මට file request එකක් දාන්න 😀..."""

    OLD_ALRT_TXT = """මචං {},
ඔයා මේ දකින්න මට වෙනකෙනෙක් දාපු පරණ File Request එකක්, 
ඒ නිසා ඔයා අලුතින් File Request එකක් දාන්න මට."""

    CUDNT_FND = """ඔයා ටයිප් කරපු File එකේ නමට අදාල File එකක් මට හොයාගන්න බැරි වුණා 🙁👉 {}
ඔයා අදහස් කලේ මේ Files අතරින් එකක්ද?"""

    I_CUDNT = """<b>ඔයා ඉල්ලපු File එක මට හොයාගන්න බැරි වුණා 🙁👉 {} 
...
🚯 මේවා Type කරන්නෙපා ':(!,./)</b>"""
    ...
    I_CUD_NT = """ඔයා හොයපු file එක නම් හොයා ගන්න බැරි වුනා 🙁. File එකේ නම 👉 {}.
පොඩ්ඩක් google එකේ search කරල බලන්න..."""
    ...
    MELCOW_ENG = """<b>කොහොමද {} 😎🤘, ඔයාව අපේ {} Group එකට සාදරයෙන් පිළිගන්නවා 🙏 ඔයාට අවශ්‍ය File එකේ නම Type කරලා Group එකට Send කරන්න. | Movies 🎬 | Tv Series 📺 | Mod Apps 📲 | Softwares 🖥️ සහ පොත්පත් 📚 ඇතුළු ගොඩක් Files මේ Group එකෙන් හොයාගන්න පුළුවන් 😎🤘. මතක ඇතුව @Bots_LK 🇱🇰 Channel එකට Join වෙලා ඉන්න ❤️</b>"""
