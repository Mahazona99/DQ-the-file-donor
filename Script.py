...
මම <a href=https://t.me/{}>{}</a> 🔥,  Movies 🎬 | Series 📺 | Mod Apps 📲 සහ පොත්පත් 📚 ඔයාට හොයාගන්න 🔎 උදව් කරන්න මට පුලුවන් ✅                               | ➡️ Search කරන්න 🔎 | Option එක හරහා ඔයාට අවශ්‍ය Files 📁 ලබාගන්න පුලුවන් වගේම, අපේ Support Group 🔆 එකට Join වෙලත් ඔයාට අවශ්‍ය Files 📁 පහසුවෙන්ම ලබාගන්න අවස්ථාව ලැබෙනවා ❤️</b>"""
...
ඒ නිසා ඔයා අලුතින් File Request එකක් දාන්න මට."""
    ...
    CUDNT_FND = """ඔයා ටයිප් කරපු File එකේ නමට අදාල දෙයක් මට හොයාගන්න බැරි වුණා {}
ඔයා අදහස් කලේ මේ Files අතරින් එකක්ද?"""

    I_CUDNT = """<b>ඔයා ඉල්ලපු ෆයිල් එක මට හොයාගන්න බැරි වුණා {} 😕
...
🚯 මේවා Type කරන්නෙපා ':(!,./)</b>"""
    ...
    I_CUD_NT = """ඔයා හොයපු file එක නම් හොයා ගන්න බැරි වුනා 😕 {}.
